...
//     var eleAnimate = document.getElementsByClassName('image');

//     Array.from(eleAnimate).forEach(function(element, index){
//         var prev = element.offsetTop;
//         if ( (scrollTop - prev) > -300) {
//             //add class animation
...
function randomNegativeOrPositive(min, max){
    return  randomMath(min, max) * (Math.random() > 0.5 ? 1 : -1)
}
...
images.forEach(function () {
  rotateXMaxList.push(randomNegativeOrPositive(20, 40))
  rotateYMaxList.push(randomNegativeOrPositive(20, 60))
})
